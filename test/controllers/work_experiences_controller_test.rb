...
class WorkExperiencesControllerTest < ActionController::TestCase
  ...
  test "should create work_experience" do
    assert_difference('WorkExperience.count') do
      post :create, work_experience: { company: @work_experience.company, description: @work_experience.description, end_date: @work_experience.end_date, name: @work_experience.name, start_date: @work_experience.start_date, user_id: @work_experience.user_id }
    end
  ...
  test "should update work_experience" do
    patch :update, id: @work_experience, work_experience: { company: @work_experience.company, description: @work_experience.description, end_date: @work_experience.end_date, name: @work_experience.name, start_date: @work_experience.start_date, user_id: @work_experience.user_id }
    assert_redirected_to work_experience_path(assigns(:work_experience))
  end
