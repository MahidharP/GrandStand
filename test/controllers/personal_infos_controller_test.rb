...
class PersonalInfosControllerTest < ActionController::TestCase
  ...
  test "should create personal_info" do
    assert_difference('PersonalInfo.count') do
      post :create, personal_info: { birthday: @personal_info.birthday, designation: @personal_info.designation, image: @personal_info.image, language: @personal_info.language, nationality: @personal_info.nationality, profile: @personal_info.profile, user_id: @personal_info.user_id }
    end
  ...
  test "should update personal_info" do
    patch :update, id: @personal_info, personal_info: { birthday: @personal_info.birthday, designation: @personal_info.designation, image: @personal_info.image, language: @personal_info.language, nationality: @personal_info.nationality, profile: @personal_info.profile, user_id: @personal_info.user_id }
    assert_redirected_to personal_info_path(assigns(:personal_info))
  end
