...
class EducationsControllerTest < ActionController::TestCase
  ...
  test "should create education" do
    assert_difference('Education.count') do
      post :create, education: { college: @education.college, end_date: @education.end_date, name: @education.name, start_date: @education.start_date, user_id: @education.user_id }
    end
  ...
  test "should update education" do
    patch :update, id: @education, education: { college: @education.college, end_date: @education.end_date, name: @education.name, start_date: @education.start_date, user_id: @education.user_id }
    assert_redirected_to education_path(assigns(:education))
  end
